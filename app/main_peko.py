...
def normal(sentence):
    ...
    # 尊敬語・謙譲語を除去
    no_sonken_sentence = remove_sonken(no_tag_sentence)
    # 丁寧語を除去
    natural_sentence = remove_teinei(no_sonken_sentence)
    # ないの？　→　ねぇーの？
    ...
    if debug: ic(no_tag_sentence, no_sonken_sentence, natural_sentence, pekonai, peko_inserted, peko_sentence, perfect_peko_sentence)
